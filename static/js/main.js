...
jQuery(function($) {
    ...
    $(document).ready(function() {
        var e = '<div class="prt_floting_customsett">' +
            '<a href="" class="tmtheme_fbar_icons"><i class="fa fa-facebook"target="_blank"></i><span>Facebook</span></a>' +
            '<a href="" class="tmtheme_fbar_icons"><i class="fa fa-instagram"target="_blank"></i><span>Instagram</span></a>' +
            '<a href="https://www.linkedin.com/showcase/nautical-global-ship-management/" class="tmtheme_fbar_icons" target="_blank"><i class="fa fa-linkedin"></i><span class="buy_link">LinkedIn<span></span></span></a>' +
